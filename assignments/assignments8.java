...
classno = Integer.parseInt(br.readLine());
...
int flag = 0;
Scanner sc = new Scanner(System.in);
System.out.print("Enter an id of the student you wantto search: ");
...
pw.println(line[0] + "\t" + line[1] + "\t" + up_mark+ "\t" +
line[3]);
...
System.out.println("Delete failed: File didn't
